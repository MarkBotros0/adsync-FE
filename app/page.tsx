...
const PLANS = [
  {
    ...
    features: ['1 brand', '500 mentions / mo', '1 page', 'Basic analytics'],
  ...
  },
  {
    ...
    features: ['3 brands', '5,000 mentions / mo', '5 pages', 'Full analytics', 'Alerts', 'Instagram', 'Export'],
  ...
  },
  {
    ...
    features: ['10 brands', '50,000 mentions / mo', '20 pages', 'AI Digest', 'Influencer tracking', 'Instagram & TikTok', 'Reports', '10 team members'],
    cta: 'Start free trial',
    highlight: true,
  },
];
