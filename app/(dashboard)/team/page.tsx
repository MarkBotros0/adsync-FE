  ...
  return (
    <div className="flex flex-col h-full">
      <div className="bg-white border-b border-slate-200 px-6 py-4 flex items-center gap-4">
        <h1 className="text-base font-bold text-slate-900">Team Members</h1>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
          ...
          {TEAM.map(member => (
            <div key={member.id} className="flex items-center gap-4 px-5 py-4">
              <div className="h-10 w-10 rounded-full bg-purple-100 flex items-center justify-center text-sm font-bold text-purple-600">
                {member.avatar}
              </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl border border-purple-200 p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-slate-800 mb-2">Collaborate with your team</h3>
          ...
          <span className="flex items-center gap-2 mx-auto bg-slate-200 text-slate-400 text-sm font-medium px-4 py-2 rounded-lg cursor-not-allowed">
            <Mail className="h-4 w-4" />
            Send Invitations
            <span className="text-[10px] font-semibold bg-slate-300 text-slate-500 px-1.5 py-0.5 rounded uppercase tracking-wide">Soon</span>
          </span>
        </div>
      </div>
    </div>
